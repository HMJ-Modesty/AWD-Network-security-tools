...
def shell(i): # post请求
    try:
        ...
        try:
            ...
            print(flags)
            urlflag = "https://ctf.bugku.com/pvp/submit.html?token=7622287182f171903fc7d8fc22b880ad&flag=" + flags
            print(urlflag)
            try:
                results = requests.get("https://ctf.bugku.com/pvp/submit.html?token=fe17d0e6004664ce7fdb5f25a5a86852&flag=" + flags, headers=headers)
                # print(results.text)
